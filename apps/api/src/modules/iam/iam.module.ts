...
import { AdminPharmacyController } from './infrastructure/controllers/admin-pharmacy.controller';
...
@Module({
  controllers: [AuthController, PharmacyController, AdminPharmacyController],
  providers: [
    IamService,
    ServiceTokenGuard,
